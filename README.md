...
- **빠른 아카콘 선택**: 사이드 패널에서 바로 아카콘을 선택하고 입력할 수 있습니다.
- **아카콘 목록 관리**: 댓글창에서 목록을 가져와 반영합니다.
- **검색**: 아카콘 태그와 초성을 기반으로 원하는 아카콘을 검색합니다.
- **콤보콘 기능**: 아카라이브의 기존 기능과 동일하게 사용 가능합니다.
- **개인화 설정**:
...
전체 라이선스는 [여기에](./LICENSE.md) 명시되어 있습니다.